...
dependencies {
    ...
    compile("org.mnode.ical4j:ical4j:3.0.11")
    ...
    compile("org.springframework.boot:spring-boot-starter-undertow:2.2.0.RELEASE")
    compile("org.springframework:spring-context-indexer:5.2.0.RELEASE")
    compile("org.springframework.boot:spring-boot-configuration-processor:2.2.0.RELEASE")
