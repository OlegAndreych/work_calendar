...
class CalendarServiceConf {
    @Bean
    fun calendarService(calendarStorage: CalendarStorage,
                        calendarDataUpdater: CalendarDataUpdater): CalendarService
            = CalendarService(calendarStorage, calendarDataUpdater)
}